...
class CustomThirdPartiesRadioButton extends StatelessWidget {
                ...
                children: [
                  Expanded(
                    child: RadioListTile(
                      ...
                      value: textRadio1,
                      groupValue: ref.watch(isThirdParties) ? "yes" : "no",
                      onChanged: (value) {
                        ref.read(isThirdParties.notifier).state = false;
                      },
                    ),
                  ),
                  Expanded(
                    child: RadioListTile(
                        ...
                        groupValue: ref.watch(isThirdParties) ? "yes" : "no",
                        onChanged: (value) {
                          ref.read(isThirdParties.notifier).state = true;
                        }),
                  ),
                ],
              );
